...
export function createDataPathForm(
  dataPath: string,
  onDataPathTextChange: (event: ChangeEvent<HTMLInputElement>) => void
) {
  return (
    <>
...
export function createTimeFormatForm(
  timeFormat: string,
  onTimeFormatTextChange: (event: ChangeEvent<HTMLInputElement>) => void
) {
  return (
    <>
      <div className={'gf-form'}>
