...
export interface Props {
  ...
  getRef?: (ref: GraphQLQueryEditor) => void;
}
...
export class GraphQLQueryEditor extends PureComponent<Props & ReduxProps, {}> {
  ...
  private closeCompletion = () => {
    if (this.editor.state.completionActive && typeof this.editor.state.completionActive.close === 'function') {
